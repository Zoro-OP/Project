<html>
  ...
  <body>
    ...
    <fieldset id="register_form" align= "center">
      ...
      <a href="../views/moderatorSearch.php" class="btn btn-outline-info">Back</a>
      ...
      <tr>
          <td  align="center">
          <input type="button" name="register" value="Verify">
          </td> 
          <td  align="right">
          <input type="submit" name="register" value="Add">
          </td>
      <td  align="center">
          <input type="button" name="register" value="Update">
          </td>
      <td colspan="2" align="left">
          <input type="button" name="register" value="Delete">
          </td>
       </tr>
        </table>
